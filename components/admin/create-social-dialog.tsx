...
import { createSocial } from "@/app/actions/socials";
...
export function CreateSocialDialog() {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new social media platform or contact link.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4 py-4">
          <div className="space-y-2">
            <Label htmlFor="name">Platform Name</Label>
            <Input id="name" name="name" placeholder="Instagram" required />
          </div>
          <div className="space-y-2">
            <Label htmlFor="handle">Handle / Display Text</Label>
            <Input id="handle" name="handle" placeholder="@username or Contact Us" required />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Select name="color" defaultValue="bg-pink-400">
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Input id="iconType" name="iconType" placeholder="instagram" />
          </div>
          <DialogFooter>
